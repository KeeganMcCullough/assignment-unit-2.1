...
switch(luckyNumber) {
  ...
  case 2:
    ...
    break;
  case 3:
    luckyResult = 'Thirs is the one with the polka dot dress';
    break;
  default:
...
console.log('for transparency, I wrote 12 with a ternary before reading the rest of the assignment; because of this i will rewrite it here without one')
